...
<body>
    ...
    <form action="nuevoUsuario.php" method="post">
        ...
        <input id="usuario" name="usuario" type="text" placeholder="Introduce tu usuario" required><br>

        <br><label for="usuario">Contraseña:</label>
        <input id="passwd" name="passwd" type="password" placeholder="Introduce tu contraseña" required>
